...
@endif
{!! Breadcrumbs::render('admin.food.index') !!}
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Food - <span class="semi-bold">List</span></h3>
</div>
<div class='control'>
    <a href="{{ URL::to('admin/food/create') }}" class="btn btn-primary">Add new Food</a>

</div>
<br>
<div class="grid simple vertical green">
    <div class="grid-title no-border">
        <h4>All <span class="semi-bold">Foods</span></h4>
        <div class="tools">
...
<script type="text/javascript" language="javascript" class="init">
    jQuery(document).ready(function ($) {
        ...
        $('#datatable-example').DataTable({
            ...
            "order": [[1, "desc"]],
            ajax: {
                "url": "{{ URL::to('admin/food/datatable') }}",
                "type": "POST"
            },
            columns: [
