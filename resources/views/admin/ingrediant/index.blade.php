...
@endif
{!! Breadcrumbs::render('admin.ingrediants.index') !!}
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Ingrediant - <span class="semi-bold">List</span></h3>
</div>
<div class='control'>
    <a href="{{ URL::to('admin/ingrediants/create') }}" class="btn btn-primary">Create an Ingrediant</a>

</div>
<br>
<div class="grid simple vertical green">
    <div class="grid-title no-border">
        <h4>All <span class="semi-bold">Ingrediant</span></h4>
        <div class="tools">
...
<script type="text/javascript" language="javascript" class="init">
    jQuery(document).ready(function ($) {
        ...
        $('#datatable-example').DataTable({
            ...
            "order": [[1, "desc"]],
            ajax: {
                "url": "{{ URL::to('admin/ingrediants/datatable') }}",
                "type": "POST"
            },
            columns: [
                {data: 'check', name: 'check'},
                {data: 'id', name: 'id'},
                {data: 'ingrediant_name', name: 'ingrediant_name'},
                {data: 'halal', name: 'halal'},
