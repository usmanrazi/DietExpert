...
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Events - <span class="semi-bold">List</span></h3>
</div>
<div class='control'>
    <a href="{{ URL::to('admin/events/create') }}" class="btn btn-primary">Create an Event</a>

</div>
<br>
<div class="grid simple vertical green">
    <div class="grid-title no-border">
        <h4>All <span class="semi-bold">Events</span></h4>
        <div class="tools">
