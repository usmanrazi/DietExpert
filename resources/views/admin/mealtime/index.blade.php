...
@endif
{!! Breadcrumbs::render('admin.mealtime.index') !!}
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Taste - <span class="semi-bold">List</span></h3>
</div>
<div class='control'>
    <a href="{{ URL::to('admin/mealtime/create') }}" class="btn btn-primary">Create a Meal Time</a>

</div>
<br>
<div class="grid simple vertical green">
    <div class="grid-title no-border">
        <h4>All <span class="semi-bold">Meal Time</span></h4>
        <div class="tools">
...
<script type="text/javascript" language="javascript" class="init">
    jQuery(document).ready(function ($) {
        ...
        $('#datatable-example').DataTable({
            ...
            "order": [[1, "desc"]],
            ajax: {
                "url": "{{ URL::to('admin/mealtime/datatable') }}",
                "type": "POST"
            },
            columns: [
                {data: 'check', name: 'check'},
                {data: 'id', name: 'id'},
                {data: 'mealtime_name', name: 'mealtime_name'},
