...
@endif
{!! Breadcrumbs::render('admin.dietoption.index') !!}
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Diet Option - <span class="semi-bold">List</span></h3>
</div>
<div class='control'>
    <a href="{{ URL::to('admin/dietoption/create') }}" class="btn btn-primary">Create an Diet Option</a>

</div>
<br>
<div class="grid simple vertical green">
    <div class="grid-title no-border">
        <h4>All <span class="semi-bold">Diet Option</span></h4>
        <div class="tools">
        ...
        <table class="table table-hover table-condensed" id="datatable-example" >
            <thead>
                <tr>
                    ...
                    <th>Diet Option id</th>
                    <th>Diet Option Name</th>
                    <th>Actions</th>
                </tr>
            </thead>
        </table>
...
<script type="text/javascript" language="javascript" class="init">
    jQuery(document).ready(function ($) {
        ...
        $('#datatable-example').DataTable({
            ...
            "order": [[1, "desc"]],
            ajax: {
                "url": "{{ URL::to('admin/Dietoption/datatable') }}",
                "type": "POST"
            },
            columns: [
                {data: 'check', name: 'check'},
                {data: 'id', name: 'id'},
                {data: 'dietoption_name', name: 'dietoption_name'},
