...
@endif
{!! Breadcrumbs::render('admin.allergies.index') !!}
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Allergies - <span class="semi-bold">List</span></h3>
</div>
<div class='control'>
    <a href="{{ URL::to('admin/allergies/create') }}" class="btn btn-primary">Create an Allergy</a>

</div>
<br>
<div class="grid simple vertical green">
    <div class="grid-title no-border">
        <h4>All <span class="semi-bold">Allergies</span></h4>
        <div class="tools">
...
<script type="text/javascript" language="javascript" class="init">
    jQuery(document).ready(function ($) {
        ...
        $('#datatable-example').DataTable({
            ...
            "order": [[1, "desc"]],
            ajax: {
                "url": "{{ URL::to('admin/allergies/datatable') }}",
                "type": "POST"
            },
            columns: [
