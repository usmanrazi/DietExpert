    ...
    <div class="col-md-12">
        <div class="grid simple">
            <div class="grid-title no-border">
                <h4>Add <span class="semi-bold">Course</span></h4>
                <div class="tools">
            ...
            <div class="grid-body no-border"> <br>
                ...
                @endif
               {!! Form::model($course,['method' => $course ? 'PATCH':'POST','route' =>$course ? ['admin.course.update', $course->id]:'admin.course.store','id'=>'form_course', 'novalidate'=>"novalidate","enctype"=>"multipart/form-data"]) !!}
                ...
                <div class="form-actions">
                    <div class="pull-right">
                        {!! Form::submit($course ? 'Update':'Save', ['class' => 'btn btn-primary btn-cons','id' => 'btn-submit']) !!}
                        </div>
                </div>
                {!! Form::close() !!}
            </div>
...
<script>
    jQuery('#form_course').submit(function (event) {
        var pass = true;
        //some validations
